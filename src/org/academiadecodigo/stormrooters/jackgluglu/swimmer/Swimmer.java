...
public class Swimmer implements KeyboardHandler {
    ...
    public void init() {
        ...
        picture = new Picture(org.academiadecodigo.stormrooters.jackgluglu.game.Game.PADDING + 100, org.academiadecodigo.stormrooters.jackgluglu.game.Game.PADDING + 200, spritesPath.get(atSprite));
